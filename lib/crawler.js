...
Crawler.prototype.removeDownloadCondition = function(index) {
    ...
    if (index instanceof Function) {
        ...
        if (index >= 0 && index < crawler._downloadConditions.length) {
            if (crawler._downloadConditions[index] !== undefined) {
                crawler._downloadConditions[index] = undefined;
                return true;
            }
        }
    }
...
Crawler.prototype.removeFetchCondition = function(index) {
    ...
    if (index instanceof Function) {
        ...
        if (index >= 0 && index < crawler._fetchConditions.length) {
            if (crawler._fetchConditions[index] !== undefined) {
                crawler._fetchConditions[index] = undefined;
                return true;
            }
        }
    }
