...
var Crawler = function(host, initialPath, initialPort, interval) {
    ...
    var hiddenProps = {
        ...
        _fetchConditions: [],
        _openListeners: 0,
        _robotsTxtFetchCondition: function () {
            return false;
        }
    };
...
Crawler.prototype.start = function() {
    ...
    crawler.getRobotsTxt(function (error, robotsTxtUrl, robotsTxtBody) {
        if (!error && crawler.respectRobotsTxt) {
            var robots = robotsTxtParser(robotsTxtUrl, robotsTxtBody);

            crawler._robotsTxtFetchCondition = function (parsedURL) {
...
Crawler.prototype.queueURL = function(url, queueItem) {
    ...
    if (fetchDenied || crawler._robotsTxtFetchCondition(parsedURL)) {
