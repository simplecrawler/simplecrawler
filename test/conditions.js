...
describe("Fetch conditions", function() {
  ...
  describe("Removing fetch conditions", function() {
    ...
    it("should be able to remove a fetch condition by ID (multiple)", function() {
      ...
      var conditionID1 = crawler.addFetchCondition(condition1);
      var conditionID2 = crawler.addFetchCondition(condition2);
      var conditionID3 = crawler.addFetchCondition(condition3);
  ...
  it("should provide fetch conditions with the right data", function(done) {
    var crawler = makeCrawler("http://127.0.0.1:3000");
    var fetchConditionCalled = false;
    ...
    crawler.addFetchCondition(function(queueItem, referrerQueueItem) {
      ...
      referrerQueueItem.stateData.should.have
        .property("headers")
        .that.includes({
          "content-length": "68"
        });
...
describe("Download conditions", function() {
  it("should be able to add a download condition", function() {
    var crawler = makeCrawler("http://127.0.0.1:3000");
    var condition = function() {};
    var conditionID = crawler.addDownloadCondition(condition);
  ...
  describe("Removing download conditions", function() {
    ...
    it("should be able to remove a download condition by ID (multiple)", function() {
      ...
      var condition2 = function() {};
      var condition3 = function() {};
      var conditionID1 = crawler.addDownloadCondition(condition1);
      var conditionID2 = crawler.addDownloadCondition(condition2);
      var conditionID3 = crawler.addDownloadCondition(condition3);
  ...
  it("should provide download conditions with the right data", function(done) {
    var crawler = makeCrawler("http://127.0.0.1:3000");
    var downloadConditionCalled = false;
  ...
  it("should not download a resource when prevented by a synchronous download condition", function(
    done
  ) {
    this.slow("1s");
  ...
  it("should not download a resource when prevented by an asynchronous download condition", function(
    done
  ) {
    this.slow("1s");
  ...
  it("should only apply download conditions when it would normally download the resource", function(
    done
  ) {
  ...
  it("should emit a downloadprevented event when a download condition returns false", function(
    done
  ) {
    var crawler = makeCrawler("http://127.0.0.1:3000");
  ...
  it("should emit a downloadconditionerror event when a download condition throws an error", function(
    done
  ) {
    var crawler = makeCrawler("http://127.0.0.1:3000");
    ...
    crawler.on(
      ...
      downloadConditionErrorListener(crawler, done)
    );
    crawler.start();
  });

  it("should emit a downloadconditionerror event when a download condition returns an error", function(
    done
  ) {
    var crawler = makeCrawler("http://127.0.0.1:3000");
