...
/**
 * @file Ensures that cookie support is functional and reliable across a variety
 * of different cookie formats. The more cookies I can add to this cookies
 * array, the better the tests!
 */
...
describe("Cookies", function() {
  ...
  it("should be able to output the cookie object as a string", function() {
    cookies.forEach(function(cookie) {
      ...
      var outputString = tmpCookie.toString(true);
      var reParsedCookie = Cookie.fromString(outputString);
  ...
  describe("Cookie Jar", function() {
    ...
    it("should be able to add cookies", function() {
      ...
      cookies.forEach(function(cookie) {
        ...
        var parsedCookie2 = cookiesAdded.pop();
    ...
    it("should be able to retrieve cookies by name", function() {
      ...
      cookies.forEach(function(cookie) {
        ...
        var parsedCookie2 = returnedCookies.pop();
    ...
    it("should be able to accept cookies from a header/s", function() {
      ...
      cookies.forEach(function(cookie) {
        var parsedCookie = Cookie.fromString(cookie);
        var returnedCookies = cookieJar.get(parsedCookie.name);
        var parsedCookie2 = returnedCookies.slice(0, 1).pop();
