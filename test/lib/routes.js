...
module.exports = {
  "/": function(write) {
    write(
      200,
      "Home. <a href='stage2'>stage2</a> <a href='forbidden'>bad robot!</a>"
    );
  },
  ...
  "/nofollow": function(write) {
    write(
      200,
      "<meta name='robots' value='nofollow'><a href='/stage7'>Don't go here!</a>"
    );
  },
  ...
  "/cookie": function(write) {
    ...
    var cookie =
      "thing=stuff; expires=" + expires + "; path=/; domain=.localhost";
  ...
  "/depth/1": function(write) {
    write(
      200,
      "<link rel='stylesheet' href='/css'> Home. <a href='/depth/2'>depth2</a>"
    );
  },
  ...
  "/depth/3": function(write) {
    write(
      200,
      "Depth 3. <link rel='stylesheet' href='/css/2'> <link rel='stylesheet' href='/css/4'>"
    );
  },
  ...
  "/css": function(write) {
    write(
      200,
      "/* CSS 1 */ @import url('/css/2'); @font-face { url(/font/1) format('woff'); }",
  ...
  "/css/2": function(write) {
    write(
      200,
      "/* CSS 2 */ @import url('/css/3'); .img1 { background-image:url('/img/1'); }",
      { "Content-Type": "text/css" }
    );
  },
  ...
  "/css/4": function(write) {
    write(
      200,
      "/* CSS 4 */ .img1 { background-image:url('/img/2'); } @font-face { url(/font/2) format('woff'); }",
      { "Content-Type": "text/css" }
    );
  },
  ...
  "/script": function(write) {
    write(
      200,
      "<script src='/not/existent/file.js'></script><script>var foo = 'bar';</script><a href='/stage2'>stage2</a><script>var bar = 'foo';</script>"
    );
  },
  ...
  "/encoded/header": function(write) {
    write(200, getFixtureFile("encoded.html"), {
  ...
  "/compressed/link": function(write) {
    zlib.gzip("<a href='/compressed/gzip'>Go to gzip</a>", function(
      error,
      result
    ) {
  ...
  "/compressed/gzip": function(write) {
    zlib.gzip("Yay, you know how to deal with gzip compression!", function(
      error,
      result
    ) {
      write(200, result, { "Content-Encoding": "gzip" });
  ...
  "/compressed/deflate": function(write) {
    zlib.deflate(
      "Yay, you know how to deal with deflate compression!",
