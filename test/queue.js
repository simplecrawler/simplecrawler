...
describe("Queue methods", function() {
  ...
  it("should error when passing unknown properties to queue methods", function(
    done
  ) {
  ...
  it("should only update queue items asynchronously", function(done) {
    ...
    var originalQueueUpdate = crawler.queue.update;
    ...
    crawler.queue.update = function(id, updates) {
      ...
      process.nextTick(function() {
        ...
        var queueQueueItem = findById(crawler.queue, id);
  ...
  it("emits a queueerror event when update method errors", function(done) {
    ...
    crawler.queue.update = function(url, updates, callback) {
      originalQueueUpdate.call(crawler.queue, url, updates, function(
        error,
        queueItem
      ) {
        if (!error) {
